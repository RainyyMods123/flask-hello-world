...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO Christ TAggers!</color>\n\n<color=#0099c2>CURRENT UPDATE: Back to school</color>\n<color=#cacfd2>BOOST THE DISCORD FOR ALL COSMETICS (EXCLUDING STAFF COS)</color>\n<color=#41ff80>Rainyyy MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: Rainyy</color>\n<color=#ac1a00>CREDITS FOR GAMES OG OS: VIPER</color>\n\n<color=#91A3B0>discord.gg/CHRISTMASTAG</color>",
