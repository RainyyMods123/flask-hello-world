...
import hashlib
import uuid
# Tippy is a loser and wont do shit to ur game!
# btw if u cannot code and cannot read this is this a photon auth for ur servers to work
TitleId = "EE766"
DeveloperSecretKey = "8G6NXO41ZTWOK6CS6OK9G35HRBSMHQZEUQ34XYIWQC6UAXCJ5P"
PHOTON_WEBHOOK_URL = "https://discord.com/api/webhooks/1502251845849059409/5qvgYGMLVzSq8qHorJmXo5vIi1JDNvkBFjs94-xnmC-U5XNzXuo3m_l-5CcyYmo-VMQl" # dihcord webhook
ApiKey = "OC|26570259929268061|8179fd2c2ecd669619d6b416bc847448"
...
def retard():
    return "Tippy's Backend, Give creds on me in game or discord or else, I will absoultely Destroy your game." # pst he wont do shit lmaoooo - bigboi
